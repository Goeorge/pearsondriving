...
const classes = [
  {
    ...
    description: 'Your level of driving skill, you find different options for Extended Driving Course.',
    price: 'Ksh.9,500',
    duration: '9 Weeks',
    level: 'Intermediate',
  ...
  },
  {
    ...
    description: 'International Driving Course is made to teach you driving all over the world.',
    price: 'Ksh.12,000',
    duration: '5 Weeks',
    level: 'Intermediate',
